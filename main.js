let mainControl = document.getElementById("main-controls")
let gameControl = document.getElementById("game-controls")
...
function startGame() {
    ...
    mainControl.classList.add("hidden")
...
function draw() {
    ...
    let highPopCountElem = document.getElementById("top-score")
...
function stopGame() {
    ...
    mainControl.classList.remove("hidden")
